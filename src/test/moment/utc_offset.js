...
//     for (i = -15; i <= 15; ++i) {
//         assert.equal(
//             customMoment().utcOffset(i).utcOffset(),
//             i * 60,
//             '' + i + ' -> ' + i * 60
//         );
//     }
//     assert.equal(customMoment().utcOffset(-16).utcOffset(), -16, '-16 -> -16');
//     assert.equal(customMoment().utcOffset(16).utcOffset(), 16, '16 -> 16');
// });
// 
// test('isLocal, isUtc, isUtcOffset', function (assert) {
//     assert.ok(customMoment().isLocal(), 'customMoment() creates objects in local time');
//     assert.ok(
//         !customMoment.utc().isLocal(),
//         'customMoment.utc creates objects NOT in local time'
//     );
//     assert.ok(
//         customMoment.utc().local().isLocal(),
//         'customMoment.fn.local() converts to local time'
//     );
//     assert.ok(
//         !customMoment().utcOffset(5).isLocal(),
//         'customMoment.fn.utcOffset(N) puts objects NOT in local time'
//     );
//     assert.ok(
//         customMoment().utcOffset(5).local().isLocal(),
//         'customMoment.fn.local() converts to local time'
//     );
// 
//     assert.ok(customMoment.utc().isUtc(), 'customMoment.utc() creates objects in utc time');
//     assert.ok(
//         customMoment().utcOffset(0).isUtc(),
//         'utcOffset(0) is equivalent to utc mode'
//     );
//     assert.ok(
//         !customMoment().utcOffset(1).isUtc(),
//         'utcOffset(1) is NOT equivalent to utc mode'
//     );
// 
//     assert.ok(
//         !customMoment().isUtcOffset(),
//         'customMoment() creates objects NOT in utc-offset mode'
//     );
//     assert.ok(
//         customMoment.utc().isUtcOffset(),
//         'customMoment.utc() creates objects in utc-offset mode'
//     );
//     assert.ok(
//         customMoment().utcOffset(3).isUtcOffset(),
//         'utcOffset(N != 0) creates objects in utc-offset mode'
//     );
//     assert.ok(
//         customMoment().utcOffset(0).isUtcOffset(),
...
//     var m = customMoment.utc([2000, 0, 1, 6]);
...
//     var m = customMoment.utc([2000, 0, 1, 6, 31]);
// 
//     m.utcOffset(0);
//     assert.equal(
//         m.format('HH:mm'),
...
// 
//     zoneC.utcOffset(60);
//     assert.equal(+zoneA, +zoneC, 'moment should equal customMoment.utcOffset(60)');
// 
//     zoneD.utcOffset(-480);
//     assert.equal(+zoneA, +zoneD, 'moment should equal customMoment.utcOffset(-480)');
// 
//     zoneE.utcOffset(-1000);
//     assert.equal(+zoneA, +zoneE, 'moment should equal customMoment.utcOffset(-1000)');
// });
...
//     var zoneA = customMoment(),
//         zoneB = customMoment(zoneA).utcOffset(-720),
//         zoneC = customMoment(zoneA).utcOffset(-360),
//         zoneD = customMoment(zoneA).utcOffset(690),
...
//     assert.equal(
//         customMoment().utcOffset(-120).clone().utcOffset(),
//         -120,
...
//     );
//     assert.equal(
//         customMoment(customMoment().utcOffset(-120)).utcOffset(),
//         -120,
...
//     var a = customMoment.utc([2010, 1, 2, 0, 0, 0]).utcOffset(-450);
// 
//     assert.equal(
...
//     var a = customMoment.utc([2012]).utcOffset(-480);
// 
//     assert.equal(
//         a.clone().hour(),
//         16,
...
//     var a = customMoment([2012]).utcOffset(-480);
// 
//     assert.equal(
//         a.clone().local().hour(),
//         0,
...
//     var zoneA = new Date(),
//         zoneB = customMoment(zoneA).utcOffset(-720).toDate(),
//         zoneC = customMoment(zoneA).utcOffset(-360).toDate(),
//         zoneD = customMoment(zoneA).utcOffset(690).toDate();
// 
//     assert.equal(
//         +zoneA,
//         +zoneB,
...
//         zoneB = customMoment(zoneA).utcOffset(-120),
//         zoneC = customMoment(zoneA).utcOffset(120);
// 
//     assert.ok(
//         zoneA.isSame(zoneB),
...
//     assert.equal(customMoment().utcOffset(-120).hasAlignedHourOffset(), true);
//     assert.equal(customMoment().utcOffset(180).hasAlignedHourOffset(), true);
//     assert.equal(customMoment().utcOffset(-90).hasAlignedHourOffset(), false);
//     assert.equal(customMoment().utcOffset(90).hasAlignedHourOffset(), false);
// });
// 
// test('hours alignment with other zone', function (assert) {
//     var m = customMoment().utcOffset(-120);
// 
//     assert.equal(m.hasAlignedHourOffset(customMoment().utcOffset(-180)), true);
//     assert.equal(m.hasAlignedHourOffset(customMoment().utcOffset(180)), true);
//     assert.equal(m.hasAlignedHourOffset(customMoment().utcOffset(-90)), false);
//     assert.equal(m.hasAlignedHourOffset(customMoment().utcOffset(90)), false);
// 
//     m = customMoment().utcOffset(-90);
// 
//     assert.equal(m.hasAlignedHourOffset(customMoment().utcOffset(-180)), false);
//     assert.equal(m.hasAlignedHourOffset(customMoment().utcOffset(180)), false);
//     assert.equal(m.hasAlignedHourOffset(customMoment().utcOffset(-30)), true);
//     assert.equal(m.hasAlignedHourOffset(customMoment().utcOffset(30)), true);
// 
//     m = customMoment().utcOffset(60);
// 
//     assert.equal(m.hasAlignedHourOffset(customMoment().utcOffset(-180)), true);
//     assert.equal(m.hasAlignedHourOffset(customMoment().utcOffset(180)), true);
//     assert.equal(m.hasAlignedHourOffset(customMoment().utcOffset(-90)), false);
//     assert.equal(m.hasAlignedHourOffset(customMoment().utcOffset(90)), false);
// 
//     m = customMoment().utcOffset(-25);
// 
//     assert.equal(m.hasAlignedHourOffset(customMoment().utcOffset(35)), true);
//     assert.equal(m.hasAlignedHourOffset(customMoment().utcOffset(-85)), true);
// 
//     assert.equal(m.hasAlignedHourOffset(customMoment().utcOffset(-35)), false);
//     assert.equal(m.hasAlignedHourOffset(customMoment().utcOffset(85)), false);
// });
// 
...
//     var m = customMoment('2013-01-01T05:00:00+00:00').parseZone();
...
//     assert.equal(customMoment().utcOffset(60).format('ZZ'), '+0100', '-60 -> +0100');
//     assert.equal(customMoment().utcOffset(90).format('ZZ'), '+0130', '-90 -> +0130');
//     assert.equal(
//         customMoment().utcOffset(120).format('ZZ'),
//         '+0200',
//         '-120 -> +0200'
//     );
// 
