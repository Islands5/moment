...
test('iso weeks year starting sunday', function (assert) {
    assert.equal(
        customMoment([2012, 0, 1]).isoWeek(),
        52,
        'Jan  1 2012 should be iso week 52'
    );
    assert.equal(
        customMoment([2012, 0, 2]).isoWeek(),
        1,
        'Jan  2 2012 should be iso week 1'
    );
    assert.equal(
        customMoment([2012, 0, 8]).isoWeek(),
        1,
        'Jan  8 2012 should be iso week 1'
    );
    assert.equal(
        customMoment([2012, 0, 9]).isoWeek(),
        2,
        'Jan  9 2012 should be iso week 2'
    );
    assert.equal(
        customMoment([2012, 0, 15]).isoWeek(),
        2,
...
test('iso weeks year starting monday', function (assert) {
    assert.equal(
        customMoment([2007, 0, 1]).isoWeek(),
        1,
        'Jan  1 2007 should be iso week 1'
    );
    assert.equal(
        customMoment([2007, 0, 7]).isoWeek(),
        1,
        'Jan  7 2007 should be iso week 1'
    );
    assert.equal(
        customMoment([2007, 0, 8]).isoWeek(),
        2,
        'Jan  8 2007 should be iso week 2'
    );
    assert.equal(
        customMoment([2007, 0, 14]).isoWeek(),
        2,
        'Jan 14 2007 should be iso week 2'
    );
    assert.equal(
        customMoment([2007, 0, 15]).isoWeek(),
        3,
...
test('iso weeks year starting tuesday', function (assert) {
    assert.equal(
        customMoment([2007, 11, 31]).isoWeek(),
        1,
        'Dec 31 2007 should be iso week 1'
    );
    assert.equal(
        customMoment([2008, 0, 1]).isoWeek(),
        1,
        'Jan  1 2008 should be iso week 1'
    );
    assert.equal(
        customMoment([2008, 0, 6]).isoWeek(),
        1,
        'Jan  6 2008 should be iso week 1'
    );
    assert.equal(
        customMoment([2008, 0, 7]).isoWeek(),
        2,
        'Jan  7 2008 should be iso week 2'
    );
    assert.equal(
        customMoment([2008, 0, 13]).isoWeek(),
        2,
        'Jan 13 2008 should be iso week 2'
    );
    assert.equal(
        customMoment([2008, 0, 14]).isoWeek(),
        3,
...
test('iso weeks year starting wednesday', function (assert) {
    assert.equal(
        customMoment([2002, 11, 30]).isoWeek(),
        1,
        'Dec 30 2002 should be iso week 1'
    );
    assert.equal(
        customMoment([2003, 0, 1]).isoWeek(),
        1,
        'Jan  1 2003 should be iso week 1'
    );
    assert.equal(
        customMoment([2003, 0, 5]).isoWeek(),
        1,
        'Jan  5 2003 should be iso week 1'
    );
    assert.equal(
        customMoment([2003, 0, 6]).isoWeek(),
        2,
        'Jan  6 2003 should be iso week 2'
    );
    assert.equal(
        customMoment([2003, 0, 12]).isoWeek(),
        2,
        'Jan 12 2003 should be iso week 2'
    );
    assert.equal(
        customMoment([2003, 0, 13]).isoWeek(),
        3,
...
test('iso weeks year starting thursday', function (assert) {
    assert.equal(
        customMoment([2008, 11, 29]).isoWeek(),
        1,
        'Dec 29 2008 should be iso week 1'
    );
    assert.equal(
        customMoment([2009, 0, 1]).isoWeek(),
        1,
        'Jan  1 2009 should be iso week 1'
    );
    assert.equal(
        customMoment([2009, 0, 4]).isoWeek(),
        1,
        'Jan  4 2009 should be iso week 1'
    );
    assert.equal(
        customMoment([2009, 0, 5]).isoWeek(),
        2,
        'Jan  5 2009 should be iso week 2'
    );
    assert.equal(
        customMoment([2009, 0, 11]).isoWeek(),
        2,
        'Jan 11 2009 should be iso week 2'
    );
    assert.equal(
        customMoment([2009, 0, 13]).isoWeek(),
        3,
...
test('iso weeks year starting friday', function (assert) {
    assert.equal(
        customMoment([2009, 11, 28]).isoWeek(),
        53,
        'Dec 28 2009 should be iso week 53'
    );
    assert.equal(
        customMoment([2010, 0, 1]).isoWeek(),
        53,
        'Jan  1 2010 should be iso week 53'
    );
    assert.equal(
        customMoment([2010, 0, 3]).isoWeek(),
        53,
        'Jan  3 2010 should be iso week 53'
    );
    assert.equal(
        customMoment([2010, 0, 4]).isoWeek(),
        1,
        'Jan  4 2010 should be iso week 1'
    );
    assert.equal(
        customMoment([2010, 0, 10]).isoWeek(),
        1,
        'Jan 10 2010 should be iso week 1'
    );
    assert.equal(
        customMoment([2010, 0, 11]).isoWeek(),
        2,
...
test('iso weeks year starting saturday', function (assert) {
    assert.equal(
        customMoment([2010, 11, 27]).isoWeek(),
        52,
        'Dec 27 2010 should be iso week 52'
    );
    assert.equal(
        customMoment([2011, 0, 1]).isoWeek(),
        52,
        'Jan  1 2011 should be iso week 52'
    );
    assert.equal(
        customMoment([2011, 0, 2]).isoWeek(),
        52,
        'Jan  2 2011 should be iso week 52'
    );
    assert.equal(
        customMoment([2011, 0, 3]).isoWeek(),
        1,
        'Jan  3 2011 should be iso week 1'
    );
    assert.equal(
        customMoment([2011, 0, 9]).isoWeek(),
        1,
        'Jan  9 2011 should be iso week 1'
    );
    assert.equal(
        customMoment([2011, 0, 10]).isoWeek(),
        2,
...
test('weeks plural year starting sunday', function (assert) {
    assert.equal(
        customMoment([2012, 0, 1]).weeks(),
        1,
        'Jan  1 2012 should be week 1'
    );
    assert.equal(
        customMoment([2012, 0, 7]).weeks(),
        1,
        'Jan  7 2012 should be week 1'
    );
    assert.equal(
        customMoment([2012, 0, 8]).weeks(),
        2,
        'Jan  8 2012 should be week 2'
    );
    assert.equal(
        customMoment([2012, 0, 14]).weeks(),
        2,
        'Jan 14 2012 should be week 2'
    );
    assert.equal(
        customMoment([2012, 0, 15]).weeks(),
        3,
...
test('iso weeks plural year starting sunday', function (assert) {
    assert.equal(
        customMoment([2012, 0, 1]).isoWeeks(),
        52,
        'Jan  1 2012 should be iso week 52'
    );
    assert.equal(
        customMoment([2012, 0, 2]).isoWeeks(),
        1,
        'Jan  2 2012 should be iso week 1'
    );
    assert.equal(
        customMoment([2012, 0, 8]).isoWeeks(),
        1,
        'Jan  8 2012 should be iso week 1'
    );
    assert.equal(
        customMoment([2012, 0, 9]).isoWeeks(),
        2,
        'Jan  9 2012 should be iso week 2'
    );
    assert.equal(
        customMoment([2012, 0, 15]).isoWeeks(),
        2,
        'Jan 15 2012 should be iso week 2'
    );
});
...
test('weeks setter', function (assert) {
    assert.equal(
        customMoment([2012, 0, 1]).week(30).week(),
        30,
        'Setting Jan 1 2012 to week 30 should work'
    );
    assert.equal(
        customMoment([2012, 0, 7]).week(30).week(),
        30,
        'Setting Jan 7 2012 to week 30 should work'
    );
    assert.equal(
        customMoment([2012, 0, 8]).week(30).week(),
        30,
        'Setting Jan 8 2012 to week 30 should work'
    );
    assert.equal(
        customMoment([2012, 0, 14]).week(30).week(),
        30,
        'Setting Jan 14 2012 to week 30 should work'
    );
    assert.equal(
        customMoment([2012, 0, 15]).week(30).week(),
        30,
...
test('iso weeks setter', function (assert) {
    assert.equal(
        customMoment([2012, 0, 1]).isoWeeks(25).isoWeeks(),
        25,
        'Setting Jan  1 2012 to week 25 should work'
    );
    assert.equal(
        customMoment([2012, 0, 2]).isoWeeks(24).isoWeeks(),
        24,
        'Setting Jan  2 2012 to week 24 should work'
    );
    assert.equal(
        customMoment([2012, 0, 8]).isoWeeks(23).isoWeeks(),
        23,
        'Setting Jan  8 2012 to week 23 should work'
    );
    assert.equal(
        customMoment([2012, 0, 9]).isoWeeks(22).isoWeeks(),
        22,
        'Setting Jan  9 2012 to week 22 should work'
    );
    assert.equal(
        customMoment([2012, 0, 15]).isoWeeks(21).isoWeeks(),
        21,
...
test('count years with iso week 53', function (assert) {
    ...
    var count = 0,
        i;
    for (i = 0; i < 400; i++) {
        count += customMoment([2000 + i, 11, 31]).isoWeek() === 53 ? 1 : 0;
    }
    assert.equal(
        count,
        71,
